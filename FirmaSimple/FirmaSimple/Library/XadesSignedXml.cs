    ...
    public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
    {
        ...
        private void BuildDigestedReferences()
        {
            ...
            foreach (Reference reference2 in list2)
            {
                ...
                if (reference2.Uri != null && reference2.Uri.StartsWith("#KeyInfoId-"))
                {
                ...
                else if (reference2.Type == "http://www.w3.org/2001/04/xmlenc#sha256") //http://www.w3.org/2000/09/xmldsig#Object
                {
